...
- (UIButton *)tickImageView{
    if (!_tickImageView) {
        ...
        [tickImageView setImage:[UIImage imageNamed:@"form_uncheck"] forState:UIControlStateNormal];
...
- (void)setIsVideoType:(BOOL)isVideoType{
    ...
    self.tickImageView.hidden = isVideoType;
}
...
- (void)setAnimationRightTick:(BOOL)animationRightTick{
    ...
    if (animationRightTick) {
        [self.tickImageView setImage:[UIImage imageNamed:@"form_selected"] forState:UIControlStateNormal];
    }else{
        [self.tickImageView setImage:[UIImage imageNamed:@"form_uncheck"] forState:UIControlStateNormal];
    }
