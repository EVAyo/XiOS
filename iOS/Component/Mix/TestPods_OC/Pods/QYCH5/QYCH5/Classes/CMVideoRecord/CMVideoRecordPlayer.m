...
- (void)playerButtons {
    ...
    UIImage *image      = [UIImage imageNamed:@"record_video_cancel" aClass:[self class] bundle:QYCH5];
    ...
    [_confirmButton setBackgroundImage:[UIImage imageNamed:@"icon_finish_p" aClass:self.class bundle:QYCH5] forState:UIControlStateNormal];
