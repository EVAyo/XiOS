...
if [[ "$3" == "AdHoc" ]]; then
ENG_ExportOptionsPlistPath="/Users/dong/Desktop/packerTools/AdHocExportOptionsPlist.plist"
elif [[ "$3" == "AppStore" ]];then
ENG_ExportOptionsPlistPath="/Users/dong/Desktop/packerTools/Plist/AppStoreExportOptions.plist"
elif [[ "$3" == "Enterprise" ]];then
ENG_ExportOptionsPlistPath="/Users/dong/Desktop/packerTools/Plist/EnterpriseExportOptionsPlist.plist"
elif [[ "$3" == "Development" ]];then
ENG_ExportOptionsPlistPath="/Users/dong/Desktop/packerTools/Plist/DevelopmentExportOptionsPlist.plist"
else
 echo "😯😯😯😯😯😯😯😯😯小伙子你的打包方式有问题😯😯😯😯😯😯😯😯😯"
exit 1
fi
...
# 导出包的路径
ENG_EXPORT_PATH="/Users/dong/Desktop/packerTools/AutoIpa"
...
cd ~/Desktop/packerTools/AutoIpa
